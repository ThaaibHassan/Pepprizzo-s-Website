            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@peprizzos.com</p>
                  <p className="text-gray-600">orders@peprizzos.com</p>
                </div>
              </div>
        ...
        <div className="mt-12">
          ...
          <div className="bg-gray-200 rounded-lg h-64 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400">123 Pizza Street, Downtown, City, State 12345</p>
            </div>
          </div>
        </div>
      </div>
